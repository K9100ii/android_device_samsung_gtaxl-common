...
#ifndef ANDROID_HARDWARE_SENSORS_V2_1_SENSORS_H
#define ANDROID_HARDWARE_SENSORS_V2_1_SENSORS_H
...
using ISensors = ::android::hardware::sensors::V2_1::ISensors;
...
class ISensorsCallbackWrapper : public V2_0::ISensorsCallback {
  public:
    ...
    Return<void> onDynamicSensorsConnected(const hidl_vec<V1_0::SensorInfo>& sensorInfos) override {
        return mCallback->onDynamicSensorsConnected_2_1(V2_1::implementation::convertToNewSensorInfos(sensorInfos));
    }
...
struct Sensors : public ISensors, public ISensorsEventCallback {
    ...
    Sensors()
        : mEventQueueFlag(nullptr),
          ...
          mHasWakeLock(false) {
        AddSensor<SamsungAccelSensor>();
        AddSensor<SamsungLightSensor>();
    }
    ...
    Return<Result> initialize_2_1(
        ...
        std::unique_ptr<V2_1::implementation::EventMessageQueueWrapperBase> wrapper =
                std::make_unique<V2_1::implementation::EventMessageQueueWrapperV2_1>(eventQueue);
    ...
    Return<Result> injectSensorData_2_1(const V2_1::Event& event) {
        return injectSensorData(V2_1::implementation::convertToOldEvent(event));
    }
...
#endif  // ANDROID_HARDWARE_SENSORS_V2_1_SENSORS_H
